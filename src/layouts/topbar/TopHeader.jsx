        ...
        >
            ...
            <div className="w-full">
                <div className="flex items-center justify-between">
                    ...
                    <button className="hidden max-md:block border border-[#131619] hover:bg-[#131619] transition-all h-9 w-9 p-2 rounded-md">
                        <MenuSvg />
                    </button>

                </div>
                <p className="mt-2 mb-1 text-sm sm:text-base">Marketing Campaign for a new TV series Launch</p>
            </div>
            <div className="flex flex-row max-md:items-center max-md:justify-between max-md:w-full">
