...
const SideProfile = () => {
    return (
        <div className="content">
            <div className="profile max-md:px-3 max-md:py-2">
                <div className="flex lg:flex-row md:flex-col flex-1 items-center justify-between lg:p-3 md:py-3 md:px-2">
                    <div className="flex lg:flex-row md:flex-col max-md:flex-row items-center">
                        ...
                        <div className="lg:ml-3 md:ml-0 md:text-center lg:text-left md:pt-1 lg:pt-0">
                            <h3 className="lg:text-base text-xs font-semibold">Ryan lee</h3>
                            <p className="lg:text-sm md:text-xs">Premium</p>
                        </div>
                    </div>
                    <div>
                        <button className="lg:w-5 lg:h-5 md:w-6 md:h-6 w-6 h-6 lg:mt-0 md:mt-5">
                            <GearSvg />
                        </button>
                    </div>
                </div>
